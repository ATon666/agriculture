 ...
 * @description  数据表 大气站点2 的Mapper
 */
@Mapper
public interface Atmosphere2Mapper {

    @Insert("insert into location_2_atmosphere(location,monitor,temperature,humidity,atmospheric_pressure,co2,windvelocity,winddirection,light) " +
